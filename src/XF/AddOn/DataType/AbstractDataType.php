...
abstract class AbstractDataType
{
	...
	public const USE_AUTO_CDATA = false;
	...
	public function openTypeFile($dataDir)
	{
		...
		return Xml::openFile($dataDir . \XF::$DS . $this->getTypeFileName());
	}
	...
	{
		$cdata = Xml::createDomCdataSection($parent->ownerDocument, $value);
		$parent->appendChild($cdata);
	}

	protected function getCdataValue(\SimpleXMLElement $el)
	{
		return Xml::processSimpleXmlCdata($el);
	}

	/**
	 * @template T of \XF\Mvc\Entity\Finder
	 *
	 * @param class-string<T>|null $shortName
	 *
	 * @return T
	 */

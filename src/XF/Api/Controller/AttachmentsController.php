...
class AttachmentsController extends AbstractController
{
	...
	public function actionGet()
	{
		...
		$key = $this->assertRecordExists(ApiAttachmentKey::class, $keyValue);
	...
	public function actionPostNewKey()
	{
		...
		$key = $this->em()->create(ApiAttachmentKey::class);
	...
	{
		/** @var AttachmentPlugin $plugin */
		$plugin = $this->plugin(AttachmentPlugin::class);

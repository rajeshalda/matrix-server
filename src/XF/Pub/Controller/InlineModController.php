...
class InlineModController extends AbstractController
{
	public function actionIndex()
	{
		if ($this->isPost())
		{
			return $this->rerouteController(self::class, 'perform');
		}
		else
		{
			return $this->rerouteController(self::class, 'showActions');
		}
	}
	...
	{
		return $this->plugin(InlineModPlugin::class)->getInlineModHandler($type);
	}

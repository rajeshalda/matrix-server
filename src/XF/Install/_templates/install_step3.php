	...
	<div class="block-container">
		<div class="block-body">
			<dl class="formRow formRow--input">
				...
				<dd>
					<input type="text" name="username" autocomplete="username" value="" class="input" id="ctrl_username" />
				</dd>
			</dl>
			<dl class="formRow formRow--input">
				<dt><label class="formRow-label" for="ctrl_password">Password</label></dt>
				<dd>
					<input type="password" name="password" autocomplete="new-password" value="" class="input" id="ctrl_password" />
				</dd>
			</dl>
			<dl class="formRow formRow--input">
				<dt><label class="formRow-label" for="ctrl_password_confirm">Confirm password</label></dt>
				<dd>
					<input type="password" name="password_confirm" autocomplete="new-password" value="" class="input" id="ctrl_password_confirm" />
				</dd>
			</dl>
			<dl class="formRow formRow--input">
				<dt><label class="formRow-label" for="ctrl_email">Email</label></dt>
				<dd>
					<input type="email" name="email" autocomplete="email" value="" class="input" id="ctrl_email" />
				</dd>
			</dl>
		</div>
				...
				<div class="formSubmitRow-main">
					...
					<div class="formSubmitRow-controls">
						<button accesskey="s" class="button button--primary button--icon button--icon--save">
							<?php echo $templater->fontAwesome('fa-save') ?>

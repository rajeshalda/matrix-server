...
use XF\BbCode\ProcessorAction\LimitTags;
...
class SignatureEditService extends AbstractService
{
	/**
	 * @var User
	 */
	...
	protected function setupBbCodeLimits(LimitTags $limit)
	{
	...
	protected function validateSignature($signature, Processor $processor, &$errors = [])
	{
		$errors = [];
